export const metadata = {
  title: 'Условия бронирования | SHYMKENT STUDIO',
  description: 'Условия бронирования и оплаты услуг SHYMKENT STUDIO',
};
        ...
        <div className="container-max max-w-3xl">
          ...
          <div className="prose prose-sm max-w-none text-text-secondary space-y-6">
            <div>
              ...
              <p>
                Бронирование услуг SHYMKENT STUDIO осуществляется через веб-сайт путём заполнения формы бронирования. Бронирование становится активным только после полной оплаты.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Вы являетесь владельцем прав на записанный контент. SHYMKENT STUDIO не может использовать записи для маркетинга без вашего письменного согласия.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                SHYMKENT STUDIO не несёт ответственность за потерю данных из-за сбоев технического оборудования, если это произойдёт не по вине студии. Мы делаем резервные копии всех записей, но рекомендуем также сохранять копии самостоятельно.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                SHYMKENT STUDIO оставляет за собой право изменять эти условия в любое время. Об изменениях будет объявлено на веб-сайте.
              </p>
            </div>
